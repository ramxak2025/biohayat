...
export const metadata: Metadata = {
  ...
  description:
    "Оптовые поставки натуральных витаминов и БАД ХАЯТ от производителя ООО «Восток»: 119+ позиций, скидки до −38% от розницы, отгрузка от 10 шт, доставка по всей России.",
};
